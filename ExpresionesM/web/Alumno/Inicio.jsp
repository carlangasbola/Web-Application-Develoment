...
<html>
    ...
    <body>
        ...
        <!-- Contenedor : Solo muestra el nombre del alumno -->
        <div class="container">
            <div class="jumbotron" align="center">
                <h2>Bienvenido Alumno : <i class="text-danger"> <s:property value="#session.userId" /> </i> </h2>
        ...
        <!-- Ver diagrama asignado NO PROGRAMADO AUN -->
        <h3 align="center"> 
