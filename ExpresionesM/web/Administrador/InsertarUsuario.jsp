...
<html>
    ...
    <body>
        ...
        <s:form action="insertar_usuario">
            
            <s:textfield cssClass="form-control mx-sm-2" name="nombre" label="Usuario"  placeholder="ID Nuevo" required="required"/>
            <s:password  cssClass="form-control mx-sm-2" name="password" label="Password" placeholder="Contraseña Nueva" required="required"/>
