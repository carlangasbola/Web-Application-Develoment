...
<html>
    ...
    <body>
        ...
        <s:iterator value="lista_diagrama">
            <tr>
                <td><s:property value="idDiagrama" /></td>
                <td><a href='verDiagrama.action?idDiagrama=<s:property value="idDiagrama" />'> Ver Diagrama </a></td>
                <td><a href='borrarDiagrama.action?idDiagrama=<s:property value="idDiagrama" />'> Eliminar </a></td>
            </tr>
        </s:iterator>
